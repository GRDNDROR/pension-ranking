  ...
  const weights = [
    {
      ...
      description:
        "הפרמטר המרכזי ביותר. ביצועי הקרן כוללים: תשואה ל-5 שנים (30%), תשואה ל-3 שנים (20%), יחס שארפ - מדד לתשואה מותאמת סיכון (20%), אלפא - תשואה עודפת מעל הבנצ'מרק (15%), עקביות בביצועים - סטיית תקן נמוכה מעידה על יציבות (10%), ותשואה מתחילת השנה (5%). דגש על תשואות ארוכות טווח כי הפנסיה היא חיסכון לטווח ארוך.",
    },
    {
      name: "איזון אקטוארי",
    ...
    {
      name: "איכות שירות וזמינות",
      weight: SCORING_WEIGHTS.serviceQuality.weight,
      description:
        "מבוסס על מדד השירות של רשות שוק ההון (2024), כולל זמני מענה טלפוני, איכות מענה, טיפול בתלונות ציבור ונגישות שירות דיגיטלי. בעתיד ישולב גם מדד זמינות שנמדד באופן עצמאי (מדידת זמני המתנה בשירות הלקוחות). חברות שלא נכללו במדד מקבלות ציון ניטרלי (50).",
    },
    {
      name: "שיעור אישור תביעות",
      weight: SCORING_WEIGHTS.claimsApproval.weight,
      description:
        "אחוז גבוה של אישור תביעות נכות ושאירים מצביע על קרן שמכבדת את המבוטחים שלה. פרמטר חשוב במיוחד למקבלי קצבה. נתון זה מקבל כרגע ציון ניטרלי - יתעדכן כשהנתונים יהיו זמינים מרשות שוק ההון.",
    },
    {
      name: "דמי ניהול",
      weight: SCORING_WEIGHTS.fees.weight,
      description:
        "פרמטר שולי - מגבלת הוצאות הניהול החיצוניות של כל מסלול. כולל דמי ניהול שנתיים (70%) ודמי ניהול מהפקדה (30%). חשוב: אלו לא דמי הניהול האישיים שמשלם כל עמית (שנקבעים לפי שכר וצבירה).",
    },
    {
      name: "גודל קרן",
      weight: SCORING_WEIGHTS.fundSize.weight,
      description:
        "פרמטר משני - קרנות גדולות נהנות מיציבות ופיזור סיכונים טובים יותר. הנורמליזציה לוגריתמית.",
    },
    {
      name: "זרימת כספים",
      weight: SCORING_WEIGHTS.netFlow.weight,
      description:
        "פרמטר משני - יחס הפקדות נטו לסך הנכסים, מדד ל\"הצבעת רגליים\" של המבוטחים. במסלולי מקבלי קצבה, זרימה שלילית טבעית ולכן ניתן ציון ניטרלי.",
    },
  ];
