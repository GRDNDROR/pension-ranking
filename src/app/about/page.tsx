    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-3 text-sm leading-relaxed">
          <p>
            השוואת קרנות פנסיה בישראל מתמקדת בדרך כלל בתשואות קצרות טווח
            ובדמי ניהול. אך בחירת קרן פנסיה היא החלטה ארוכת טווח שצריכה לקחת
            בחשבון גורמים רבים נוספים.
          </p>
          <p>
            מדד איכות קרנות הפנסיה נוצר כדי לספק תמונה רחבה יותר - מדד מורכב
            שמשלב תשואות ארוכות טווח, יציבות אקטוארית, איכות שירות, שיעור אישור
            תביעות, זרימת כספים וגודל קרן.
          </p>
          <p>
            המטרה היא לעזור לציבור לקבל החלטות מושכלות יותר לגבי קרן הפנסיה
            שלהם, על בסיס ניתוח מקיף של מדדי איכות ויציבות.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-3 text-sm leading-relaxed">
          ...
          <p>
            הנתונים מתעדכנים באופן אוטומטי מדי חודש (תשואות)
